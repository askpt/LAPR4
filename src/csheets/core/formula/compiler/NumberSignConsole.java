 ...
 * (adapted from Console.java)
 * @author João Carreira
 * @see csheets.core.formula.compiler.Console
 */
public class NumberSignConsole 
{
	 ...
	 */
	public NumberSignConsole(InputStream in, OutputStream out) 
        {
            ...
            NumberSignExpressionCompiler compiler = new NumberSignExpressionCompiler();
			...
			new NumberSignFormulaLexer(new StringReader(line)));
                    try 
                    {
                        parser.expression();
	...
	public static void main(String[] args)  
        {
            new NumberSignConsole(System.in, System.out);
	}
}